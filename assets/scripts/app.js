...
$(function() {
  ...
  function init(json) {
        ...
        twitter: function() {
          var url = encodeURIComponent(window.location.origin + window.location.pathname),
              text = "Chaque jour, @libe donne la parole à des confinés, de tout poil, pour raconter leur vie à l’intérieur. Les galères petites ou grosses, les angoisses parfois mais aussi les joies et petits bonheurs imprévus " + url,
